...
public class AnnaIdli extends JFrame {
	 ...
	 */
	public AnnaIdli() {
		int price[] = {60,95,90,110,80,165,115};
		...
		JLabel lblNewLabel_1 = new JLabel("Vanakkam to Anna Idli");
		...
		table.setModel(new DefaultTableModel(
			new Object[][] {
				{"Idli (2 pcs)", new Integer(60)},
				{"Podi Idli", new Integer(95)},
				{"Masala Dosa", new Integer(90)},
				{"Rava Plain Dosa", new Integer(110)},
				{"Medu Vada (2 pcs)", new Integer(80)},
				{"Pesarattu Dosa", new Integer(165)},
				{"Curd Rice", new Integer(115)},
			},
			new String[] {
		...
		lblNewLabel_3.setIcon(new ImageIcon("C:\\Users\\GURUMOORTY\\Downloads\\idli1.jpg"));
		lblNewLabel_3.setBounds(661, 141, 200, 276);
