...
public class Dominos extends JFrame {
	 ...
	 */
	public Dominos() {
		int price[] = {199,395,395,395,305,450,570};
		...
		JLabel lblNewLabel_1 = new JLabel("Dominos Awaits its Brilliant Customer");
		...
		table.setModel(new DefaultTableModel(
			new Object[][] {
				{"Margarita", new Integer(199)},
				{"Farmhouse", new Integer(395)},
				{"Peppy Paneer", new Integer(395)},
				{"Veggie Deluxe", new Integer(395)},
				{"Chicken Sausage", new Integer(305)},
				{"Chicken Golden Delight", new Integer(450)},
				{"Chicken Pepperoni", new Integer(570)},
			},
			new String[] {
				"Name of the Item (All Medium Only)", "Price"
			}
		) {
		...
		comboBox6.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				myCartItems[5]= "Chicken Golden Delight";
			}
		});
		...
		comboBox7.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				myCartItems[6]= "Chicken Pepperoni";
			}
		});
		...
		lblNewLabel_3.setIcon(new ImageIcon("C:\\Users\\GURUMOORTY\\Downloads\\pizza1.png"));
		lblNewLabel_3.setBounds(664, 148, 210, 285);
